...
export default function Artilharia() {
  return (
    <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
      <Image source={manutencao}></Image>
      <Text style={{fontSize: 30, fontWeight: 'bold'}}>Página em Manutenção</Text>
      <Text style={{fontSize: 20, fontWeight: 'bold'}}>Volte mais tarde</Text>
    </View>
  );
}
